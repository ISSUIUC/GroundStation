...
const color_change = document.getElementById("color");
...
window.onload = function () {
    ...
    var canvas_lowgimuA = document.getElementById("lowgimuA");
    var ctx_lowgimuA = canvas_lowgimuA.getContext('2d');
    const chart_lowgimuA = new chart_js_1.Chart(ctx_lowgimuA, {
    ...
    var canvas_lowgimug = document.getElementById("lowgimuG");
    var ctx_lowgimug = canvas_lowgimug.getContext('2d');
    const lowgimug = new chart_js_1.Chart(ctx_lowgimug, {
        // The type of chart we want to create
        type: 'line',
        // The data for our dataset
        data: {
    ...
    var canvas_lowgimum = document.getElementById("lowgimuM");
    var ctx_lowgimum = canvas_lowgimum.getContext('2d');
    const lowgimum = new chart_js_1.Chart(ctx_lowgimum, {
        // The type of chart we want to create
        type: 'line',
        // The data for our dataset
        data: {
    ...
    var canvas_gps = document.getElementById("gps");
    var ctx_gps = canvas_gps.getContext('2d');
    const gps = new chart_js_1.Chart(ctx_gps, {
        // The type of chart we want to create
        type: 'line',
        // The data for our dataset
        data: {
    ...
    var canvas_kx134 = document.getElementById("kx134");
    var ctx_kx134 = canvas_kx134.getContext('2d');
    const kx134 = new chart_js_1.Chart(ctx_kx134, {
        // The type of chart we want to create
        type: 'line',
        // The data for our dataset
        data: {
    ...
    var canvas_H3LIS331DL = document.getElementById("H3LIS331DL");
    var ctx_H3LIS331DL = canvas_H3LIS331DL.getContext('2d');
    const H3LIS331DL = new chart_js_1.Chart(ctx_H3LIS331DL, {
        // The type of chart we want to create
        type: 'line',
        // The data for our dataset
        data: {
    ...
    var canvas_barometer = document.getElementById("barometer");
    var ctx_barometer = canvas_barometer.getContext('2d');
    const barometer = new chart_js_1.Chart(ctx_barometer, {
        // The type of chart we want to create
        type: 'line',
        // The data for our dataset
        data: {
